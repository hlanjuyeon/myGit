...
<body>
	...
	<div class="MainContainer" align="center">
		...
		<h1>연차이용 현황페이지</h1>
			...
			<!-- 수정하기 버튼 -->
			<br> 
			<input type="button" class="button" value="사원목록 보기" onclick="location.href='/dayOff/list'"/>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="button" class="button" value="수정 하러 가기" onclick="location.href='/dayOff/modify?no=${dayOffInfo.no}'"/>
	</div>
</body>
</html>